...
public class AvailablePortFinderTest
{
  ...
  {
    final int p1 = AvailablePortFinder.getNextAvailable();
    final int p2 = AvailablePortFinder.getNextAvailable();
  ...
  {
    final int p1 = AvailablePortFinder.getNextAvailable(9123);
    final int p2 = AvailablePortFinder.getNextAvailable(9123);
  ...
  {
    final int p1 = AvailablePortFinder.getNextAvailable(11000);
    final ServerSocket socket = new ServerSocket(p1);
    final int p2 = AvailablePortFinder.getNextAvailable(p1);
    Assert.assertFalse("Port " + p1 + " Port2 " + p2, p1 == p2);
    socket.close();
  }
